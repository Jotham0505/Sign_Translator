...
class Numberwritescreen extends StatefulWidget {
  const Numberwritescreen({super.key});

  @override
  State<Numberwritescreen> createState() => _NumberwritescreenState();
}

class _NumberwritescreenState extends State<Numberwritescreen> {
  @override
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: wcontroller.submitPressed,
                        child: Container(
                          width: screenWidth / 4.44,
                          height: screenHeight / 25.80,
                          decoration: BoxDecoration(
